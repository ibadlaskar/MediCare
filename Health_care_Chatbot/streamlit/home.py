...
if __name__=="__main__":
    ...
    st.markdown(
            ...
            <style>
            .stApp {{
                background-image: url("https://img.freepik.com/free-photo/robot-handshake-human-background-futuristic-digital-age_53876-129770.jpg");
    ...
    st.title("Your Personalised MediCare ChatBot")
    ...
    st.markdown("- **Immediate Medical Support**: MediCare ChatBot offers instant access to medical information and guidance, providing timely support when you need it the most.")
    ...
    st.markdown("- **Educational Resource**: Engaging with the MediCare ChatBot not only offers immediate assistance but also serves as an educational resource, enhancing your medical knowledge and promoting self-care.")
